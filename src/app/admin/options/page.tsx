...
export default function Home() {
  ...
  const [columns, setColumns] = useState<OptionItem[][]>([[], [], [], [], []]);
  const columnsNames = [
    "type d'annonce",
    "categorie",
    "sous-categorie",
  ...
  const [editModal, setEditModal] = useState<{ open: boolean; option: OptionItem | null; colIdx: number }>({ open: false, option: null, colIdx: 0 });
  ...
  const handleSelect = (colIdx: number, option: OptionItem) => {
  ...
  const handleEditClick = (option: OptionItem, colIdx: number) => {
